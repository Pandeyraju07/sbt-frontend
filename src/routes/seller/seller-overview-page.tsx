...
import sellerHero from '@/assets/sbt-seller-scene.png'
...
export function SellerOverviewPage() {
  return (
    <div className="min-h-screen w-full flex flex-col bg-white text-slate-900 font-sans selection:bg-red-100 selection:text-red-900">
      ...
      <header className="w-full h-16 sm:h-20 px-6 sm:px-10 lg:px-12 flex items-center justify-between border-b border-black/[0.04] bg-white z-20 shrink-0">
        ...
        <div className="flex items-center gap-8 lg:gap-14">
          ...
          <nav className="hidden md:flex items-center gap-7 text-[13px] font-medium text-slate-600">
            ...
            <Link to={ROUTES.seller.root} className="text-slate-900 font-bold relative py-1">
              <span>Sell</span>
        ...
        {/* Right: Search + Login & Create Account */}
        <div className="flex items-center gap-4">
          <div className="relative hidden sm:flex items-center w-56 lg:w-64">
            <Search className="pointer-events-none absolute left-3.5 size-4 text-slate-400" />
            <input
              type="text"
              placeholder="Search for products, brands..."
              className="w-full h-9 pl-9 pr-3.5 rounded-full bg-slate-50 border border-slate-200/80 text-xs text-slate-800 placeholder:text-slate-400 focus:outline-none focus:border-[#DF1927] focus:ring-2 focus:ring-[#DF1927]/15 transition"
            />
          </div>

          <Link to={ROUTES.login} className="text-xs sm:text-[13px] font-semibold text-slate-700 hover:text-slate-900 transition">
            Login
          </Link>
      ...
      {/* ---------------------------------------------------------------------- */}
      {/* MAIN TWO-COLUMN SELLER WORKSPACE                                        */}
      {/* ---------------------------------------------------------------------- */}
      <main className="flex-1 w-full flex flex-col lg:flex-row items-stretch overflow-hidden">
        {/* Left Section: Seller Pitch, Features & Metrics */}
        <div className="lg:w-[48%] xl:w-[46%] flex flex-col justify-between p-6 sm:p-10 lg:pl-12 lg:pr-6 pt-6 sm:pt-10 z-10">
          <div className="space-y-4 max-w-xl">
            ...
            {/* Main Headline */}
            <h1 className="text-3xl sm:text-4xl lg:text-[42px] xl:text-[46px] font-black text-slate-900 tracking-tight leading-[1.08]">
              Grow
              <br />
              <span className="text-[#DF1927]">Your Business</span>
              <br />
              Together.
            </h1>
            ...
            <p className="text-slate-500 text-xs sm:text-[13px] leading-relaxed max-w-md pt-1 pb-3">
              Join thousands of sellers on SBT and reach millions of trusted buyers. A simpler, smarter way to sell online.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2 pb-2">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-xs font-bold text-slate-900 leading-tight">Wide Reach</h3>
                  <p className="text-[11px] text-slate-400 leading-tight mt-0.5">
                    Access a growing base of buyers
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-xs font-bold text-slate-900 leading-tight">Grow Faster</h3>
                  <p className="text-[11px] text-slate-400 leading-tight mt-0.5">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-xs font-bold text-slate-900 leading-tight">Trusted Platform</h3>
                  <p className="text-[11px] text-slate-400 leading-tight mt-0.5">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-xs font-bold text-slate-900 leading-tight">Dedicated Support</h3>
                  <p className="text-[11px] text-slate-400 leading-tight mt-0.5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-6 border-t border-slate-200/70 max-w-lg">
              <div className="sm:border-r sm:border-slate-200/80 sm:pr-3">
                ...
                <p className="text-[10px] text-slate-400 font-medium leading-tight mt-1">Active Sellers</p>
              </div>
              <div className="sm:border-r sm:border-slate-200/80 sm:pr-3">
                <p className="text-base sm:text-lg font-black text-slate-900 leading-none">1M+</p>
                <p className="text-[10px] text-slate-400 font-medium leading-tight mt-1">Happy Buyers</p>
              </div>
              <div className="sm:border-r sm:border-slate-200/80 sm:pr-3">
                <p className="text-base sm:text-lg font-black text-slate-900 leading-none">500+</p>
                <p className="text-[10px] text-slate-400 font-medium leading-tight mt-1">Product Categories</p>
              </div>
              <div>
        ...
        {/* Right Section: 3D Archway, Delivery Boxes, & Dashboard Laptop */}
        <div className="lg:w-[52%] xl:w-[54%] flex flex-col justify-between items-end overflow-hidden relative">
          <div className="w-full flex-1 flex items-center justify-center lg:justify-end overflow-hidden">
            <img
              src={sellerHero}
              alt="SBT 3D Seller Archway Scene with Dashboard Laptop and Boxes"
